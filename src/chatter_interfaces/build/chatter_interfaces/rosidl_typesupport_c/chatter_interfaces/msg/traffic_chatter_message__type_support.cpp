...
static const _TrafficChatterMessage_type_support_symbol_names_t _TrafficChatterMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chatter_interfaces, msg, TrafficChatterMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chatter_interfaces, msg, TrafficChatterMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chatter_interfaces, msg, TrafficChatterMessage)() {
  return &::chatter_interfaces::msg::rosidl_typesupport_c::TrafficChatterMessage_message_type_support_handle;
}
